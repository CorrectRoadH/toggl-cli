pub const OUTDATED_APP_ERROR_MESSAGE: &str = "If this keeps happening, please file an issue here:";
pub const CLIENT_NAME: &str = "github.com/CorrectRoadH/toggl-cli/toggl-cli";
...
pub const CREDENTIALS_EMPTY_ERROR: &str = "Please set your API token first by calling toggl auth <API_TOKEN>. Or export it as TOGGL_API_TOKEN.";
...
pub const CREDENTIALS_OVERRIDE_ERROR: &str = "You have set TOGGL_API_TOKEN in your environment. Unset it to update or delete your saved credentials.";
